    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-card border border-border rounded-xl p-4">
          <p className="text-muted-foreground" style={{ fontSize: '0.72rem', fontWeight: 500 }}>Número de pedidos</p>
          <p className="text-foreground mono" style={{ fontSize: '1.6rem', fontWeight: 700 }}>{periodOrders.toLocaleString('pt-BR')}</p>
        </div>
        <div className="bg-card border border-border rounded-xl p-4">
          <p className="text-muted-foreground" style={{ fontSize: '0.72rem', fontWeight: 500 }}>Valor financeiro das vendas</p>
          <p className="text-foreground mono" style={{ fontSize: '1.6rem', fontWeight: 700 }}>{brl(periodValue)}</p>
        </div>
      </div>
